export function about() {
    ...
    <div class="mt-5 flex lg:flex-row flex-col px-6 lg:justify-center">
      <a href="/register" class="py-[14px] font-bold px-7 text-[#333333] bg-white inline-block m-0 lg:mr-1 rounded-full">${slides[currentSlide].button1Text}</a>
      <a href="/contacts" class="py-[14px] mt-2 inline-block lg:m-0 font-bold px-7 bg-red-700 text-white rounded-full">${slides[currentSlide].button2Text}</a>
    </div>
  `;
