                    ...
                    <div class="">
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-x-3 gap-y-3 lg:gap-x-5 mt-6">
                            <div class="shadow-md rounded-lg p-6">
                                <span class="font-semibold text-[14px] text-gray-500">Panier</span>
                                <span class="block text-[20px] lg:text-[24px] my-2 font-medium text-gray-800">0
                                    Produits</span>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-500 text-xs font-light">Produits</span>
                                    <span><img src="/images/svgs/cart.svg.svg" alt="icon of shopping cart"></span>
                                </div>
                            </div>
                            <div class="shadow-md rounded-lg p-6">
                                <span class="font-semibold text-[14px] text-gray-500">Ma liste d'envies</span>
                                <span class="block text-[20px] lg:text-[24px] my-2 font-medium text-gray-800">0
                                    Produits</span>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-500 text-xs font-light">Produits</span>
                            ...
                            <div class="shadow-md rounded-lg p-6">
                                <span class="font-semibold text-[14px] text-gray-500">Produits present</span>
                                <span class="block text-[20px] lg:text-[24px] my-2 font-medium text-gray-800">0
                                    Produits</span>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-500 text-xs font-light">Produit(s) commandé(s)</span>
                            ...
                            <div class="shadow-md rounded-lg p-6">
                                ...
                                <div class="flex justify-between items-center text-gray-500">
                                    <span class="text-xs font-light">Produits</span>
                                    <span><img src="/images/svgs/cart.svg.svg" alt="icon of shopping cart"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-7 grid grid-cols-1 lg:grid-cols-12 lg:gap-8">
                            <div class="p-0 mt-4 lg:mt-0 lg:p-6 col-span-4">
                                <div class="">
                                    <h3 class="font-bold text-[17px]">Progression de la livraison</h3>
                                    <p class="text-gray-500">Suivi du processus de livraison de votre commande achetée
                                        sur
                                        Deballage</p>
                                </div>
                                <div class=""></div>
                            ...
                            <div class="p-0 lg:p-6 mt-4 lg:mt-0 col-span-8">
                                <div class="">
                                    <h3 class="font-bold text-[17px]">Votre tableau de dépenses</h3>
                                    <p class="text-gray-500">Découvrez où vous dépensez le plus dans votre expérience
                                        d’achat numérique.</p>
                                </div>
                                <div class="mt-4">
