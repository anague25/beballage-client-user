                    ...
                    <form @submit.prevent="registerUser">
                        <div class="pt-[0px] flex flex-col gap-y-[10px]">
                            <div class="form-group">
                                <label class="text-sm font-medium mb-2 inline-block" for="user_first_name">Nom</label>
                            ...
                            <div class="form-group">
                                <label class="text-sm font-medium mb-2 inline-block" for="user_last_name">Prenom</label>
                            ...
                            <div class="form-group">
                                <label class="text-sm font-medium mb-2 inline-block" for="phone">Numéro de
                                    téléphone</label>
                            ...
                            <div class="form-group">
                                <label class="text-sm font-medium mb-2 block" for="gender">Genre</label>
                            ...
                            <div class="form-group">
                                <label class="text-sm font-medium mb-2 block" for="confirm_user_password">Confirmez le
                                    mot de passe</label>
                                <input class="block w-full py-3 px-3 border-[1.5px] border-gray-400" type="password"
