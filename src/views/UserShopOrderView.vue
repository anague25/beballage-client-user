                ...
                <div class="py-5 lg:px-[25px] px-4">
                    <div class="flex flex-col lg:flex-row justify-between lg:items-center">
                        <div class="">
                            ...
                            <span class="text-gray-600 text-base">Liste des commandes de la boutique
                            </span>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3 text-center">Nom d'utilisateur </th>
                                        <th class="px-4 py-3 text-center">Quantité</th>
                                        <th class="px-4 py-3 text-center">Ville</th>
                                        <th class="px-4 py-3 text-center">Trimestre</th>
                                ...
                                <tbody>
                                    ...
                                    <tr v-if="orders.length > 0" v-for="order in orders" class=" py-3 border">


                                        <td class=" px-3 py-4 font-semibold text-black text-center">
                                        ...
                                        <td class="px-4 py-3 text-ms font-semibold border text-center">
                                            {{ order.deliveries?.city }}</td>
                                        <td class="px-4 py-3 text-ms font-semibold border text-center">
                                            {{ order.deliveries?.neighborhood }}</td>
                                        <td class="px-4 py-3 text-ms font-semibold border text-center">
