...
const actions = {
  async fetchProductsImages({ commit }, { page = 1 }) {
    try {
  ...
  async fetchAllProductsImages({ commit },id) {
    try {
      const response = await productsImagesService.fetchAllProductsImages(id);
  ...
  async createProductsImage({ commit }, productsImage) {
    try {
      const response = await productsImagesService.createProductImage(productsImage);
  ...
  async deleteProductsImage({ commit }, productsImage) {
    try {
      await productsImagesService.deleteProductImage(productsImage);
